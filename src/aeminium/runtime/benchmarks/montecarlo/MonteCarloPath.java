...
public class MonteCarloPath extends PathId {
	 ...
	 *            The number of time steps for which to generate.
	 */
	public MonteCarloPath(String name, int startDate, int endDate, double dTime, int returnDefinition, double expectedReturnRate, double volatility,
			int nTimeSteps) {
		/**
		 * These instance variables are members of PathId class.
		 */
	...
	public void computeFluctuationsGaussian(long randomSeed) throws DemoException {
		...
		double gauss;
		// doublemeanGauss=0.0, variance=0.0;
		for (int i = 0; i < nTimeSteps; i++) {
