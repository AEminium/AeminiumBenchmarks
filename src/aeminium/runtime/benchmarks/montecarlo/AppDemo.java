...
public class AppDemo {
	...
	class AppDemoThread implements Runnable {
		...
		public void run() {
			...
			slice = (nRunsMC + MAX_THREADS - 1) / MAX_THREADS;

			ilow = id * slice;
			iupper = (id + 1) * slice;
			if (id == MAX_THREADS - 1) iupper = nRunsMC;
	...
	public void runThread() {
		...
		Runnable thobjects[] = new Runnable[MAX_THREADS];
