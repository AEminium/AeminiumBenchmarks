...
public class AeIntegrate {
	...
	double area;
		...
		try {
			ret = recEval(l, r, (l * l + 1.0) * l, (r * r + 1.0) * r, area);
	    ...
	    Task leftSide = rt.createNonBlockingTask(leftBody, Runtime.NO_HINTS);
	    rt.schedule(leftSide, current, Runtime.NO_DEPS);
	    IntegralBody rightBody = new IntegralBody(c, r, fc, fl, ar);
	    Task rightSide = rt.createNonBlockingTask(rightBody, Runtime.NO_HINTS);
