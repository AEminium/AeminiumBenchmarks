...
public class RayTracer {
	...
	public static int DEFAULT_THRESHOLD = 10;
	...
	public void render(Interval interval) {
		...
		iterateLines(interval, viewVec, upVec, leftVec, r, col);
	}
	...
	protected void renderLine(int y, Interval interval, Ray r, Vec col, Vec viewVec, Vec leftVec, Vec upVec) {
		double ylen, xlen;
		int x, red, blue, green;
